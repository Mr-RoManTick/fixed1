...
def reg():
    ...
    try:
        ...
        reg2()
    r = requests.get("https://raw.githubusercontent.com/HackedDok/hedi-crack-pro/main/server.txt").text
    if to in r:
        os.system('clear')
        print(logo)
        print("")
    
        os.system("xdg-open https://www.facebook.com/profile.php?id=100070320053368")
        time.sleep(5)
        menu()
    else:
        os.system("clear")
        ...
        os.system("xdg-open https://wa.me/+2348144525050")
        reg()
def reg2():
    os.system("clear")
    print(logo)
...
☆☆                     ☆☆  ☆          ☆
     ...
     \033[41m\033[1;37m Coded By Muhammad \033[41m\033[1;37mMr RoManTic \x1b[0m\n""")
...
\033[41m\033[1;37m Am New To this? \033[41m\033[1;37mBuh You Will Soon Acknowledge Me!!! \x1b[0m\n""")
